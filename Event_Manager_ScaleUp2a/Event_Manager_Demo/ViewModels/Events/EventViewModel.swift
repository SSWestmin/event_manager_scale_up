...
// USAGE: Refactor 1: Removes Attendee business logic
// Refactor 2: Removes Admin business l
// EventVM now only deals with driving API views
...
class EventViewModel: ObservableObject {
    ...
    // MARK: No form states for events
